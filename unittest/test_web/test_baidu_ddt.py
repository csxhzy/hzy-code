...
class TestBaidu(unittest.TestCase):
    ...
    # 参数化读取JSON文件
    @file_data('C:\\Users\\Administrator\\PycharmProjects\\unittest\\test_web\\aa.json.json')
    ...
    # 参数化读取yaml文件
    @file_data('C:\\Users\\Administrator\\PycharmProjects\\unittest\\test_web\\bb.yaml.yaml')
